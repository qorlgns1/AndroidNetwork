...
public class ImageActivity extends AppCompatActivity {
    ...
    class DrawThread extends Thread{
        ...
        public void run(){
            try{
                //이미지 URL 만들기
                //URL url = new URL("https://taegon.kim/wp-content/uploads/2018/05/image-5.png");
    ...
    class SaveThread extends Thread{
        public void run(){
            try{
                ...
                //다운로드 받은 내용을 저장 배열을 생성
                byte [] raster = new byte[con.getContentLength()];

                //파일의 내용을 읽어서 raster에 저장하고 내용을 기록
        ...
        public void handleMessage(Message message){
            ...
            String imagePath =
                    Environment.getDataDirectory().getAbsolutePath()
                            + "/data/data/naver.rlgns1129.androidnetwork/files/" + filename;
            ...
            public void onClick(View view) {
                switch( view.getId()){
                    ...
                    case R.id.saveimage:
                        ...
                        String imagePath = Environment.getDataDirectory().getAbsolutePath() + "/data/naver.rlgns1129.androidnetwork/files/" + "1.png";
                        //File 객체 생성
